...
(* OASIS_START *)
(* DO NOT EDIT (digest: 42b3b5459846d2fc289470ad5c782c05) *)
(*
...
let setup_t =
  {
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "Receive-Email API Reference";
     ...
     oasis_version = "0.4.2";
     oasis_digest = Some "P\148\002)\213\026N)\148\216\156\142\200\012b\136";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
