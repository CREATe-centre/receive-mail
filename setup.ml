...
(* OASIS_START *)
(* DO NOT EDIT (digest: 538a6110eef16d3c8255d33467c38d0a) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/dominicjprice/receive-mail";
          synopsis = "A simple SMTP server for OCaml";
          description =
            Some
              [
                 OASISText.Para
                   "A lightweight SMTP server component for OCaml intended for developers who need to accept emails received via SMTP into their applications. Accepts all emails sent to it."
              ];
          categories = [];
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "receive_mail";
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install_dir = "$htmldir/receive-mail";
                      doc_title = "receive-mail API Reference";
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/dominicjprice/receive-mail.git";
                      src_repo_browser =
                        Some "https://github.com/dominicjprice/receive-mail";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\198dj\218\182\255s\145\143*OND\134\205R";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
